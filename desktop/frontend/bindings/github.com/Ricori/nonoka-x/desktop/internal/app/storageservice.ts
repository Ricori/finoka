...
export function Relocate(target: string, destination: string): $CancellablePromise<$models.RelocationProgress> {
    return $Call.ByID(949009638, target, destination);
}
...
export function ResetLocation(target: string): $CancellablePromise<$models.RelocationProgress> {
    return $Call.ByID(2004125115, target);
}
